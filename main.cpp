...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Dilithium-seeder\n"
...
static const string mainnet_seeds[] = {"seed.dilithiumcoin.io", "seed2.dilithiumcoin.io", ""};
static const string testnet_seeds[] = {""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("explorer.dilithiumcoin.io", 8680), true);
    db.Add(CService("explorer2.dilithiumcoin.io", 8680), true);
  }
  do {
